...
dispatchDial (Parcel &p, RequestInfo *pRI) {
    ...
    int32_t t;
    int32_t uusPresent;
#if defined(MODEM_TYPE_XMM7260) || defined(MODEM_TYPE_M7450) || defined(MODEM_TYPE_MDM9X35)
    char *csv;
#endif
    status_t status;
 ...
 || defined(MODEM_TYPE_M7450) || defined(MODEM_TYPE_MDM9X35)
            dial.uusInfo = NULL;
